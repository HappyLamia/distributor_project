			...
			<tbody>
				...
				?>
						<tr>
							...
							<td> 
								<a onclick="return confirm('Apa Anda Ingin Menghapus Data Ini ?')" href="<?php echo base_url('admin-page/master/tracker/delete/').$key->kode_track.'/'.$key->kode_sales ?>"><i class="fa fa-times"></i></a>
							</td>
						</tr>
				<?php 
					}
