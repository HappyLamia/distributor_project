	...
	<div class="content-top-1">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<hr>
				<form method="POST" role="form" onsubmit="return confirm('Anda Akan Menyimpan Data Ini , Lanjutkan ?')" method="POST" action="<?php echo base_url('admin-page/supplier/add') ?>">
				...
				?>
						<tr>
							...
							<td>
								...
								<a onclick="return confirm('Apa Anda Ingin Menghapus Data Ini ?')" class="btn btn-danger" href="<?php echo base_url('admin-page/supplier/delete/').$key->id_supplier ?>"><i class="fa fa-trash"></i></a>
							</td>
						</tr>
						    ...
						    <div class="modal-dialog">
						        <div class="modal-content">
						            ...
						            <div class="modal-body">
						            	<form method="POST" role="form" onsubmit="return confirm('Anda Akan Mengubah Data Ini , Lanjutkan ?')" method="POST" action="<?php echo base_url('admin-page/supplier/update') ?>">
						            		<div class="form-group">
												<label class="text-primary"> Kode Supplier</label>
