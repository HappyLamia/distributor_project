<div class="col-lg-12">
				...
				<table class="table table-bordered">
					<tr>
						...
						<td>
							...
							?>
									<option value="<?php echo $key->kode_barang ?>"><?php echo $key->nama_barang ?></option>
							<?php 
								}
							?>
						</select>
					...
					<tr class="hidden"> 
						...
						<td>:</td>
						<td><input name="nama" readonly type="text" class="form-control" id="nama_barang"></td>
					</tr>
					<tr>
	...
	<div class="col-lg-12 table-responsive">
		<table class="table table-bordered">
			<thead>
				<tr>
					<th>No</th><th>No Product</th><th>Name</th><th>Qty</th><th>Price</th><th>Sub Total</th><th class="text-center" colspan="2">Action</th>
				</tr>
			</thead>
			<tbody>
				<?php
			    ...
			    ?>
				            <tr>
								...
								<td  class="text-center"><a class="btn btn-default" href="<?php echo base_url('penjualan/remove_cart/'). $items['rowid']?>"><i class="fa fa-trash"></i></a>
								</td>
				            </tr>
			    <?php
			    ...
			    <tr>
			    	...
			    	<td><b>Total</b></td>
			    	<td>:</td>
			    	<td><b><?php echo "Rp. ".$this->cart->format_number($total); ?></b></td>
			    </tr>
			</tbody>
		</table>
		<br>
		<a class="col-sm-2 col-sm-offset-9 btn btn-primary" href="<?php echo base_url('admin-page/penjualan/checkout') ?>">Checkout</a>
	</div>
