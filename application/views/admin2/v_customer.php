					...
					?>
							<tr>
								...
								<td>
									...
									<a onclick="return confirm('Apa Anda Ingin Menghapus Data Ini ?')" class="btn btn-danger" href="<?php echo base_url('admin-page/customer/delete/').$key->id_customer ?>"><i class="fa fa-trash"></i></a>
								</td>
							</tr>
							    ...
							    <div class="modal-dialog">
							        <div class="modal-content">
							            ...
							            <div class="modal-body">
							            	<form method="POST" role="form" action="<?php echo base_url('admin-page/customer/update') ?>">
												<div class="form-group">
													<label class="text-primary"> Kode Customer</label>
													<input readonly type="text" name="kode_customer" class="form-control" value="<?php echo $kode; ?>"/>
												</div>
												...
												<div class="form-group">
													<button class="btn btn-block btn-success"><i class="fa fa-plus"></i> Update Customer</button>
												</div>
											</form>
							            </div>
							        </div>
